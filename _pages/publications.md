...
* [3] Guo Qinglang, Yong Liao,  **Li Z**, Shanyin Li, Pengyuan Zhou, and Shenglin Liang, Neighborhood-Aware Convolutional Models for Effective Link Prediction in Knowledge Graph Embedding, IJCAI Workshop, Accept, **CCF A**
...
* [5] Di WU, Liting Jiang, Lili Yin, **Li Z**, Hao Huang, CEA-Net: A Co-interactive External Attention Network for Joint Intent Detection and Slot Filling, Neural Computing, and Applications. Accept, **CCF C**
* [6] Yan Ke, Wanghao Mo, **Li Z**, Ruyi Cao, Wendong Zhang, MDCN: Multi-Scale Dilated Convolutional Enhanced Residual Network for Traffic Sign Detection, The 19th anniversary of the International Conference on Advanced Data Mining and Applications (ADMA'23). Accept, **CCF C**
