...
## <i class="fas fa-fw fa-user section-icon" aria-hidden="true"></i> Biography

Dr. Zhe Li is a Postdoctoral Fellow at **The University of Hong Kong (HKU)**. His research focuses on speech large language models (Speech LLMs), efficient adaptation, speaker representation learning, and speech-related health applications. He received his PhD in Electrical and Electronic Engineering from The Hong Kong Polytechnic University.

## <i class="fas fa-fw fa-bullhorn section-icon" aria-hidden="true"></i> News
...
## <i class="fas fa-fw fa-microphone-alt section-icon" aria-hidden="true"></i> Research Interests
...
## <i class="fas fa-fw fa-briefcase section-icon" aria-hidden="true"></i> Academic Positions
...
## <i class="fas fa-fw fa-graduation-cap section-icon" aria-hidden="true"></i> Education
...
## <i class="fas fa-fw fa-trophy section-icon" aria-hidden="true"></i> Selected Awards
